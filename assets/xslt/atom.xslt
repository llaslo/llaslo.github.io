...
<xsl:template match="/atom:feed">
  ...
  <nav class="top-bar" role="navigation" data-topbar>
    <ul class="title-area">
      <li class="name">
      <h1 class="show-for-small-only"><a href="http://localhost:4000" class="icon-tree"> Llaslo.guru</a></h1>
    </li>
...
<div id="masthead-no-image-header">
	<div class="row">
		<div class="small-12 columns">
			<a id="logo" href="http://localhost:4000" title="Llaslo.guru – Code to live! Live to code!">
				<img src="http://localhost:4000/assets/img/llaslo_guru_logo.png" alt="Llaslo.guru – Code to live! Live to code!">
			</a>
